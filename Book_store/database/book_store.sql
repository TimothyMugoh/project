...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2019 at 10:13 AM
...
(5, 'jacton mulagi', 'otingajacton@gmail.com', 'more books');
...
(3, 'jacton mulagi', ' 9090', 201556, 'nairobi', 'nairobi', 700309590, '0700309590');
...
INSERT INTO `user` (`u_id`, `u_fnm`, `u_unm`, `u_pwd`, `u_gender`, `u_email`, `u_contact`, `u_city`, `verified`, `token`) VALUES
(4, 'admin', 'admin', 'admin123', 'Female', 'admin@gmail.com', '9859632561', 'Rajkot', 0, NULL),
(7, 'jackton mulagi', 'jackton mulagi', '0700309590', 'Male', 'jactonray@outlook.sg', '0700309590', 'Bhavnagar', 0, NULL);
